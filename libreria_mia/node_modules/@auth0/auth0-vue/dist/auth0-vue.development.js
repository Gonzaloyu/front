(function (global, factory) {
  ...
  class Auth0Plugin {
      constructor(clientOptions, pluginOptions) {
          ...
          this.mfa = PLUGIN_NOT_INSTALLED_CLIENT.mfa;
      ...
      install(app) {
          this._client = new Wa(Object.assign(Object.assign({}, this.clientOptions), { auth0Client: {
                  name: 'auth0-vue',
                  version: version
              } }));
      ...
      async loginWithCustomTokenExchange(options) {
          return this.__proxy(() => this._client.loginWithCustomTokenExchange(options));
      }
      ...
      async getDpopNonce(id) {
          return this.__proxy(() => this._client.getDpopNonce(id));
      }
      async setDpopNonce(nonce, id) {
      ...
      createFetcher(config) {
          return this._client.createFetcher(config);
      }
      async __checkSession(router) {
          ...
          try {
              if ((search.includes('code=') || search.includes('error=')) &&
                  ...
                  const appStateTarget = appState === null || appState === void 0 ? void 0 : appState.target;
                  const target = appStateTarget !== null && appStateTarget !== void 0 ? appStateTarget : '/';
                  if (router) {
                      window.history.replaceState({}, '', window.location.pathname);
                      router.push(target);
                  }
                  else {
                      window.history.replaceState({}, '', appStateTarget !== null && appStateTarget !== void 0 ? appStateTarget : window.location.pathname);
                  }
                  return result;
              }
              else {
              ...
              if (router) {
                  router.push(((_b = this.pluginOptions) === null || _b === void 0 ? void 0 : _b.errorPath) || '/');
              }
          }
      }
  ...
  async function createGuardHandler(client, to, redirectLoginOptions) {
      const fn = async () => {
          ...
          await client.loginWithRedirect(Object.assign(Object.assign({}, redirectLoginOptions), { appState: Object.assign({ target: to.fullPath }, redirectLoginOptions === null || redirectLoginOptions === void 0 ? void 0 : redirectLoginOptions.appState) }));
          return false;
      };
  ...
  var Auth0Vue = /*#__PURE__*/Object.freeze({
    ...
    User: He,
    InMemoryCache: ke,
    LocalStorageCache: _e,
    UseDpopNonceError: w,
    MfaRequiredError: f,
    MfaError: Pa,
    MfaListAuthenticatorsError: Aa,
    MfaEnrollmentError: Ra,
    MfaChallengeError: xa,
    MfaVerifyError: Ia,
    MfaEnrollmentFactorsError: Oa,
