...
import type { GetTokenSilentlyOptions, GetTokenSilentlyVerboseResponse, GetTokenWithPopupOptions, IdToken, PopupConfigOptions, PopupLoginOptions, RedirectLoginResult, ConnectAccountRedirectResult, FetcherConfig, Fetcher, CustomFetchMinimalOutput, MfaApiClient, CustomTokenExchangeOptions, TokenEndpointResponse } from '@auth0/auth0-spa-js';
...
export declare class Auth0Plugin implements Auth0VueClient {
    ...
    idTokenClaims: Ref<IdToken | undefined, IdToken | undefined>;
